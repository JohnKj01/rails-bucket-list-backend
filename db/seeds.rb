...
Item.create(name: "Travel to Santorini, Greece", completed: true, category: travel, user_id: user1.id)
...
Item.create(name: "Visit the Glacier national park", completed: true, category: travel, user_id: user3.id)
...
Item.create(name: "Go to the gym and lift heavy 3 times a week", completed: true, category: lifestyle, user_id: user1.id)
...
Item.create(name: "Talk to parents once a week", completed: true, category: lifestyle, user_id: user3.id)
...
Item.create(name: "Try Curling", completed: true, category: experience, user_id: user1.id)
...
Item.create(name: "See a live musical", completed: true, category: experience, user_id: user3.id)
